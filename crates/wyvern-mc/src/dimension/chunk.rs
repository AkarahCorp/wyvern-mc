use voxidian_protocol::{registry::RegEntry, value::{Biome, BlockState as ProtocolState, ChunkSection as ProtocolSection, Identifier, PaletteFormat, PalettedContainer}};
...
impl ChunkSection {
    ...
    pub fn set_block_at(&mut self, pos: Position<usize>, block: BlockState) {
        self.blocks[*pos.x()][*pos.y()][*pos.z()] = unsafe {
            RegEntry::new_unchecked(block.protocol_id().try_into().unwrap())
        };
    }
